...
const translations = {
    zh: {
        ...
        // Atlas
        'atlas.title': '细胞图谱数据库',
        'atlas.desc': '探索我们收录的植物单细胞数据集',
        'atlas.viewDetails': '查看详情 →',
        'atlas.arabidopsis.name': '拟南芥 <em>Arabidopsis</em>',
        'atlas.arabidopsis.desc': '模式植物全器官单细胞图谱，涵盖根、茎、叶、花等组织',
        'atlas.arabidopsis.meta': '120,000+ 细胞',
        'atlas.rice.name': '水稻 <em>Oryza sativa</em>',
        'atlas.rice.desc': '重要粮食作物的发育图谱，追踪胚胎到成熟的细胞命运',
        'atlas.rice.meta': '200,000+ 细胞',
        'atlas.maize.name': '玉米 <em>Zea mays</em>',
        'atlas.maize.desc': 'C4植物叶片与根系的细胞多样性研究',
        'atlas.maize.meta': '150,000+ 细胞',
        'atlas.tomato.name': '番茄 <em>Solanum lycopersicum</em>',
        'atlas.tomato.desc': '果实发育与成熟过程中的细胞转录组动态',
        'atlas.tomato.meta': '180,000+ 细胞',
        'atlas.poplar.name': '杨树 <em>Populus</em>',
        'atlas.poplar.desc': '木本植物形成层与木质部发育的单细胞解析',
        'atlas.poplar.meta': '100,000+ 细胞',
        'atlas.more.name': '更多物种',
        'atlas.more.desc': '持续更新中，敬请期待更多植物物种的单细胞数据',
        'atlas.more.link': '合作咨询 →',
        ...
        'research.r1.point2': '<strong>农作物应用</strong>：将研究扩展至水稻，通过 scRNA-seq 与 scATAC-seq 整合分析，揭示单子叶植物根系的细胞分化轨迹',
    ...
    en: {
        ...
        'atlas.desc': 'Explore our curated plant single-cell datasets',
        'atlas.viewDetails': 'View Details →',
        'atlas.arabidopsis.name': 'Arabidopsis <em>thaliana</em>',
        'atlas.arabidopsis.desc': 'Whole-organ single-cell atlas of the model plant, covering root, stem, leaf, and flower tissues',
        'atlas.arabidopsis.meta': '120,000+ cells',
        'atlas.rice.name': 'Rice <em>Oryza sativa</em>',
        'atlas.rice.desc': 'Developmental atlas of a major crop, tracing cell fate from embryo to maturity',
        'atlas.rice.meta': '200,000+ cells',
        'atlas.maize.name': 'Maize <em>Zea mays</em>',
        'atlas.maize.desc': 'Cellular diversity study of C4 plant leaves and root systems',
        'atlas.maize.meta': '150,000+ cells',
        'atlas.tomato.name': 'Tomato <em>Solanum lycopersicum</em>',
        'atlas.tomato.desc': 'Transcriptomic dynamics during fruit development and ripening',
        'atlas.tomato.meta': '180,000+ cells',
        'atlas.poplar.name': 'Poplar <em>Populus</em>',
        'atlas.poplar.desc': 'Single-cell analysis of cambium and xylem development in woody plants',
        'atlas.poplar.meta': '100,000+ cells',
        'atlas.more.name': 'More Species',
        'atlas.more.desc': 'Continuously updating, stay tuned for more plant single-cell data',
        'atlas.more.link': 'Collaborate →',
        ...
        'research.r1.point2': '<strong>Crop Applications</strong>: Extended to rice through integrated scRNA-seq and scATAC-seq analysis, revealing cell differentiation trajectories in monocot roots',
